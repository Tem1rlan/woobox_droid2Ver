...
object Constants {
    ...
    object Config {
         const val DEFAULT_URL = "http://192.168.100.27:8080/test/"
         const val BASE_URL= DEFAULT_URL+"wp-json/"
         const val consumerKey = "fOAk4PbC9hlw"
         const val consumerSecret = "IUeTtvx6HpyjSuIq2qmNXUVAQMubcZAzeSTtrD3Wxb74XnsN"
         const val token = "QotDwdcHo7QyxUmDsaZ8MEkM"
         const val tokenSecret = "IxA7u5oXsclKqWceiUb2N2L85KGGU4MzUAFIIjEaLtGYIZq0"
    }
