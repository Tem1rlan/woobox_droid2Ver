...
interface RestApis {
    ...
    @GET("woobox-api/api/v1/woocommerce/get-single-product")
    fun listSingleProduct(@Query("pro_id") pro_id: Int): Call<ArrayList<ProductModelNew>>

//    @GET("woobox-api/api/v1/woocommerce/get-product")
//    fun listSingleProduct(@Body request: RequestModel, @Header("token") token: String = getApiToken(), @Header("id") id: String = getUserId()): Call<ArrayList<ProductDataNew>>
}
